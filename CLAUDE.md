...
## Before anything: consult the graph and read PROJECT_SATATE.md at the root

Always read `PROJECT_STATE.md` located at the root of the project before changing code.
...
2. If any test fails, dispatch the **coder** to debug and fix the _code_ (never
